...
@section('content')
    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
        <div class="container-fluid py-5">
            <h1 class="display-5 fw-bold">¡Bienvenido al Panel de Administrativo!</h1>
            <p class="col-md-8 fs-5">Estás a punto de tener un gran impacto en la experiencia de nuestros clientes. Aquí puedes gestionar y actualizar el menú, supervisar los pedidos, ver las reseñas y mucho más. Tu contribución es fundamental para mantener nuestro restaurante en la cima.</p>
        </div>
    </div>
    <div class="">
            ...
            <div class="col-4 mt-3">
                <div class="card border-primary text-center">
                    <div class="card-body">
                        ...
                        <a href="{{ route('categories.index') }}" class="btn btn-primary"><button type="button" class="btn btn-primary">Ir a las Categorías</button></a>
                    </div>
                </div>
            </div>
            <div class="col-4 mt-3">
