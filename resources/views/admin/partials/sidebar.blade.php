...
<aside class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
    ...
    <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
            <h3 class="offcanvas-title" id="sidebarMenuLabel">Admin</h3>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" data-bs-target="#sidebarMenu" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2 {{ $title == 'Inicio' ? 'active' : '' }}"  href="{{ route('admin.home') }}">
                        <svg class="bi"><use xlink:href="#house-fill"/></svg>
                        Inicio
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2 {{ $title == 'Ordenes' ? 'active' : '' }}" href="{{ route('orders.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2 {{ $title == 'Encuestas' ? 'active' : '' }}" href="{{ route('surveys.index') }}">
